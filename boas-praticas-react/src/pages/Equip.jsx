export default function Intro() {
  ...
  <ol>
    <li>
      <strong>Finalidade profissional:</strong> 
    ...
    <li>
      <strong>Softwares e arquivos pessoais:</strong> 
    ...
    <li>
      ...
      <ul>
        ...
        <li>c. É expressamente proibido abrir equipamentos e dispositivos para ver a parte interna ou tentar fazer qualquer tipo de manutenção, sendo o setor do GTI o único responsável pelo serviço.</li>
      </ul>
    </li>
  </ol>
  ...
  <ol>
    <li>
      <strong>Uso correto:</strong> Não utilize periféricos para fins pessoais ou atividades não relacionadas ao trabalho.
    </li>
    <li>
      <strong>Reparos e substituições:</strong>
      <ul>
  ...
  <ol>
    <li>
      ...
      <ul>
        <li>a. Os celulares e chips corporativos devem ser utilizados para comunicações e tarefas relacionadas ao trabalho.</li>
        <li>b. O uso para atividades pessoais, como ligações privadas ou redes sociais, é proibido, salvo autorização explícita do gestor responsável.</li>
      </ul>
    </li>
    <li>
      <strong>Conservação e devolução:</strong>
      <ul>
        <li>a. É responsabilidade do colaborador cuidar adequadamente dos dispositivos, mantendo-os em bom estado.</li>
        <li>b. Em caso de desligamento, os dispositivos devem ser devolvidos imediatamente ao GTI.</li>
      </ul>
    </li>
  </ol>
