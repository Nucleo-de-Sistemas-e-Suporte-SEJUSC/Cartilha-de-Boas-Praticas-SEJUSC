export default function Intro() {
  ...
  <ul>
    ...
    <li>b. <strong>Atenção:</strong> Folhas com informações de usuários ou de servidores não podem ser jogadas em lixo comum, devem ser trituradas ou incineradas!</li>
  </ul>
  ...
  <ul>
    ...
    <li><h4>3.3.3.2 Resmas de papel:</h4> O papel fornecido é de uso exclusivo para as atividades institucionais. Evite desperdício e imprima em frente e verso sempre que possível, contribuindo para a sustentabilidade.</li>
    <li><h4>3.3.3.3 Toners e suprimentos:</h4> A substituição de toners deve ser feita exclusivamente pela equipe responsável da empresa terceirizada ou pela GTI, quando orientado. É proibido o manuseio pelos colaboradores, salvo em casos excepcionais autorizados.</li>
  </ul>

  <h4>3.3.4 - Monitoramento e Controle de Impressões</h4>
  <ul>
    <h4>3.3.4.1 Monitoramento:</h4><li> A empresa terceirizada realiza o monitoramento do volume de impressões, garantindo que o uso esteja dentro dos limites contratados e reportando possíveis excessos ou usos inadequados.</li>
    <h4>3.3.4.2 Relatórios de impressão:</h4><li> Relatórios periódicos sobre o uso das impressoras podem ser solicitados pela gestão da SEJUSC para avaliação do consumo por setor e identificação de irregularidades.</li>
  </ul>

  <h4>3.3.5 - Exceções e Casos Especiais</h4>
  <ul>
    <h4>3.3.5.1 <strong>Uso pessoal autorizado:</strong></h4>
    <li>
    ...
    <h4>3.3.5.2 <strong>Impressões externas:</strong></h4>
    <li> Caso as impressoras internas não estejam disponíveis, o gestor pode aprovar a solicitação de serviços externos mediante justificativa.</li>
  </ul>
